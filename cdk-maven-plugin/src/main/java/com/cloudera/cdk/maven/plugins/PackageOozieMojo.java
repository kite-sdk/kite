...
public class PackageOozieMojo extends AbstractOozieMojo {
   ...
   */
  @Parameter(property = "cdk.workflowFileEncoding", defaultValue = "UTF-8")
  private String encoding;

  /**
   * The version of the Oozie workflow schema.
   */
  @Parameter(property = "cdk.schemaVersion", defaultValue = "0.4")
  private String schemaVersion;

  /**
   * The name of the workflow.
   */
  @Parameter(property = "cdk.workflowName", defaultValue = "${project.build.finalName}")
   ...
   */
  @Parameter(property = "cdk.coordinatorFile",
