...
import static org.kitesdk.data.CompressionFormat.*;
...
public class Formats {
  ...
  public static final Format CSV = new Format("csv", Uncompressed,
      new CompressionFormat[] { Uncompressed });
