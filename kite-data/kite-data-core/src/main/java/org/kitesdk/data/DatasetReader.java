 ...
 * </p>
 * <p>
 * Use subsystem-specific implementations of this interface to read data
 * from a {@link Dataset}. Readers are use-once objects that produce entities of
 * type {@code E}. Normally, you do not instantiate
 ...
 * You typically receive an instance of this interface from a dataset, call
 ...
 * </p>
 * <p>
 * Implementations might hold system resources until the {@link #close()} method
 ...
 * only method you can subsequently call is {@code close()}.
 * </p>
 * <p>
...
public interface DatasetReader<E> extends Iterator<E>, Iterable<E>, Closeable {
   ...
   * this method) can be performed; however, your implementation might permit
