...
public class SaxonMorphlineTest extends AbstractMorphlineTest {
  ...
  public void testXQueryTweetUsers() throws Exception {
    ...
    record.put(Fields.ATTACHMENT_BODY, in);
    processAndVerifySuccess(record, 
        ImmutableMultimap.of("followers_count", "111", "id", "11111112", "screen_name", "fake_user1", "statuses_count", "11111"),
        ImmutableMultimap.of("followers_count", "222", "id", "222223", "screen_name", "fake_user2", "statuses_count", "22222")
        );    
    in.close();
  }  
