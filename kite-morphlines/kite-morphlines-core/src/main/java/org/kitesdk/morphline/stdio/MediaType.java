...
/* Shaded from Apache tika-1.3 in order to reduce potential future dependency conflicts */
/**
 * Internet media type.
 */
final class MediaType implements Comparable<MediaType>, Serializable {
