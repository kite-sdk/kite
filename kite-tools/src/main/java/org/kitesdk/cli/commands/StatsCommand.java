...
@Parameters(commandDescription="Create a Dataset statistics Dataset, as a Metadatadataset")
public class StatsCommand extends BaseDatasetCommand {

  public StatsCommand(Logger console) {
    super(console);
  }

  @Parameter(description="<source dataset> <description dataset>")
