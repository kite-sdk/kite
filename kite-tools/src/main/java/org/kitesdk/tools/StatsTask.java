...
public class StatsTask<E> extends Configured {
  ...
  public StatsTask(View<E> from, View<E> to, Class<E> entityClass) {
    this.from = from;
    this.to = to;
  ...
  public StatsTask noCompaction() {
    this.compact = false;
    this.numWriters = 0;
    return this;
  }

  public StatsTask setNumWriters(int numWriters) {
